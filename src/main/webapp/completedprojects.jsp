...
<html lang="en">
   <head>
      <!-- Basic Page Needs
         ================================================== -->
      <meta charset="utf-8">
      <title>Completed -Arya Constructions </title>
      ...
      <div class="body-inner">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="banner-heading" data-aos="fade-up">
                           <h1 class="banner-title" style="font-family: 'Times New Roman', serif; font-weight: bold;">Completed Projects</h1>
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb justify-content-center">
                                 <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                                 <li class="breadcrumb-item"><a href="completedprojects.jsp">Completed Projects</a></li>
                              </ol>
                           </nav>
                        </div>
                     </div>
        ...
        <section id="main-container" class="project-area pb-2">
            <div class="container">
                ...
                <div class="row">
                    <%
                        // Query to select completed projects
                        String selectQuery = "SELECT * FROM `addproject` WHERE status = 'completed'";
                        Statement stmt = null;
                        ResultSet rs = null;
                                                     ...
                                                     <div class="swiper-slide" style="overflow: hidden; border-radius: 10px;">
                                                         <div class="item" style="text-align: center; padding: 20px;">
                                                             ...
                                                             <div class="main-button border-top" style="padding-top: 10px; margin-top: 15px; border-top: 1px solid #ddd;">
                                                                 <a href="projects-single2.jsp?url=<%= rs.getString("url") %>" style="color: #007bff; font-size: 14px; text-decoration: none; display: inline-block; padding: 8px 15px; border: 1px solid #007bff; border-radius: 5px; transition: background-color 0.3s ease, color 0.3s ease;">
